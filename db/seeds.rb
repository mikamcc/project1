...
", location:'Sydney', opening_hours:'Mon – Sun: 11:00 - 22:30', vegan_option: 1, restaurant_image: "http://placekitten.com/300/300"
...
r7 = Restaurant.create name:'RaRa', summary:"They’ve imported their own noodle-making machine from Japan for fresh-as noodles every day, and head chef Scott Gault has been upskilling his ramen-making chops at Ramen Puka Puka, a popular fish-and-pork-based ramen joint in Fukuyama, Japan. Their menu will feature four omnivore soup bases (tonkotsu, chicken, shoyu and miso) and two veg/vegan options. Any meats will be ethically sourced, and they're licensed, so the drinks meny will include Japanese beers, whiskeys, umeshus, sakes, and local natural and pet-nat wines. Yum.", location:'Redfern', opening_hours:'Tue – Sun: Lunch:12:00 - 14:30, Dinner:17:30 - 22:00', vegan_option: 1, restaurant_image: "http://placekitten.com/300/300"

r8 = Restaurant.create name:'Yasaka', summary:"Yasaka specialise in tonkotsu and serve a particularly dense and rich version of it. It doesn’t have the same mud-like viscosity to Gumshara’s, or such a dominant porky flavour. It is slightly more delicate (as much as tonkotsu can be) and varied in flavour, likely from the tare (the flavour added to the bone broth before it’s served), which uses a homemade soy. For toppings, order a hunk of kakuni: pork belly braised until soft in dashi, soy, mirin, sake and sugar.", location:'Sydney', opening_hours:'Mon -Sat: 11:30 - 22:00, Sun: 11:30 - 21:00', vegan_option: 1, restaurant_image: "http://placekitten.com/300/300"
